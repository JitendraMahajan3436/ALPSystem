...
{
    public class PPCManageOrdersController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            globalData.controllerName = "PPCManageOrders";
       ...
       */
        ...
        */
        ...
        public ActionResult changeOrderStateLinewise(string status, int rowID)
        {
            ...
            try
            {
                ...
                catch (Exception exp)
                {
                    ...
                    generalHelper.addControllerException(exp, "PPCManageOrdersController", "new Logic For PPC Hold Order", ((FDSession)this.Session["FDSession"]).userId);
                }
            ...
            {
                generalHelper.addControllerException(ex, "OrderStartController", "PPCManageOrders", ((FDSession)this.Session["FDSession"]).userId);
                return Json(false, JsonRequestBehavior.AllowGet);
            }
        }
        ...
        public ActionResult UnHoldOrders()
        {
            ...
            {
                generalHelper.addControllerException(ex, "PPCManageOrdersController", "UnHoldOrders", ((FDSession)this.Session["FDSession"]).userId);
            }
            return HttpNotFound();
        }
        ...
        public ActionResult UnHoldOrder(int rowID, string remark)
        {
            ...
            catch (Exception ex)
            {
                ...
                generalHelper.addControllerException(ex, "PPCManageOrdersController", "UnHoldOrder(rowID:" + rowID + ")", ((FDSession)this.Session["FDSession"]).userId);
            }
            //finally
            //{
