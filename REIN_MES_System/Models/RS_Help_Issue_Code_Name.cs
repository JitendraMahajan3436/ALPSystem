...
namespace REIN_MES_System.Models
{
    ...
    public partial class RS_Help_Issue_Code_Name
    {
        public decimal Issue_Code_Name_ID { get; set; }
        public decimal Plant_ID { get; set; }
        public decimal Issue_Code_ID { get; set; }
        public decimal Issue_Type_ID { get; set; }
        public decimal Issue_Log_Type_ID { get; set; }
        public string Issue_Code_Name { get; set; }
