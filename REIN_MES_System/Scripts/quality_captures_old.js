$(document).ready(function (e) {
    ...
    $("#added_defect_list").on("click", "#check_quality_checkpoint", function (e) {
        ...
        $(".table tr").each(function (e) {
            ...
            if (checkpointId) {
                ...
                //if (isValid == false || isValueBasedCorrect==false)
                //{
                //    // process to check the user is selected for the defect or not

                //    if($("#quality_checkpoint_station_users_" + checkpointId).val()=="" || $("#quality_checkpoint_station_users_" + checkpointId).val()==null)
                //    {
                //        $("#" + checkpointId + " .checkpoint_message").html("Please select defect user.");
                //    }
                //}
                ...
                var item = { Checklist_ID: $("#Checklist_ID").val(), Checkpoint_ID: checkpointId, Is_Value_Based: isValueBased, Lower_Limit: $("#" + checkpointId + " .hdnLowerLimit").val(), Upper_Limit: $("#" + checkpointId + " .hdnUpperLimit").val(), User_Value: $("#checkpoint_value_" + checkpointId).val(), Remark: $("#remark_" + checkpointId).val(), Defect_ID: $("#checkpoint_defect_" + checkpointId).val(), Is_Value_Based_Correct: isValueBasedCorrect, Corrective_Actions_ID: $("#quality_corrective_actions_" + checkpointId).val(), Is_Rework_Done: $("#resolved_checklist_" + checkpointId).prop("checked"), Defect_Name: $("#checkpoint_defect_" + checkpointId +" option:selected").text(), Corrective_Actions_Name: $("#quality_corrective_actions_" + checkpointId).val(), Is_User_Value_Based: isUserValuebased, Defect_Category_ID: Defect_Category_ID, Checkpoint_Station_User_ID: stationUserId };
    ...
    function submitValue() {
        ...
        ajaxpack.postAjaxRequest(url, "plantId=" + plantId + "&shopId=" + shopId + "&lineId=" + lineId + "&stationId=" + stationId + "&serialNumber=" + serialNumber + "&userId=" + userId + "&qualityData=" + qualityRes + "&remark=" + remark, showQualityLog, "json");
    }
